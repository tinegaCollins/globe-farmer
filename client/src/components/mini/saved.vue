...
const ifSaved = ref(props.ifSaved);
const save = () => {
    console.log('saved');
    ...
    <div class="saved-wrapper">
        <div class="saved" @click="save">
            ...
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px" width="45.743px" height="45.743px" viewBox="0 0 45.743 45.743"
                style="enable-background:new 0 0 45.743 45.743;" xml:space="preserve">
                <g>
                    <path :fill="ifSaved ? 'yellow' : 'black'" d="M34.199,3.83c-3.944,0-7.428,1.98-9.51,4.997c0,0-0.703,1.052-1.818,1.052c-1.114,0-1.817-1.052-1.817-1.052
...
.saved {
    ...
    width: 30px;
    border-radius: 50%;
    border: 1px solid v-bind("ifSaved ?  'yellow' : 'grey'");
    display: grid;
    place-items: center;
